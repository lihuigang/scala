...
//        rbTree.insert(8);
        ...
        System.out.print(rbTree.root.getLeft());
        System.out.print(rbTree.root.getLeft().getLeft());
        System.out.println(rbTree.root.getLeft().getRight());

        System.out.println("right");
        System.out.print(rbTree.root.getRight());
        System.out.print(rbTree.root.getRight().getLeft());
        System.out.print(rbTree.root.getRight().getRight());
